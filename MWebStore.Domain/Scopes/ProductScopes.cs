    ...
    public static class ProductScopes
    {
        public static bool RegisterProductScopeIsValid(this Product product)
        {
            return AssertionConcern.IsSatisfiedBy(
                ...
                AssertionConcern.AssertIsGreaterThan(product.CategoryId, 0, "A categoria do produto deve ser maior que 0"),
                AssertionConcern.AssertIsGreaterThan(product.Price, 0, "O preço do produto deve ser maior que 0"),
                AssertionConcern.AssertIsGreaterThan(product.QuantityOnHand, 0, "A quantidade do produto deve ser maior que 0")
                );
        }
        ...
        {
            return AssertionConcern.IsSatisfiedBy(
                AssertionConcern.AssertIsGreaterOrEqualThan(amount, 0, "do produto deve ser maior ou igual a 0")
                );
        }

        //atualiza preço separado (apenas para administradores)
